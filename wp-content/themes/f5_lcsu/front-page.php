        ...
        <div class="row">
            <div class="small-12 columns text-center">
                <div class="row text-center">
                    <div class="small-12 columns pjm-hero-inner start">
                        <h2 class="hero-title">Local Network. National Impact.</h2>
                    </div>
                </div>
                <div class="row text-center">
                    <div class="small-12 columns pjm-hero-inner">
                        <h4 class="hero-more">LSCU & CUNA provide member credit unions visible action on the local, state and national stages.
                        </h4>
                        </h4>
                        <p class="pjm-button">
    ...
    <div class="row">
        <div class="small-12 columns v-align">
            <div class="v-align-wrap">
                <h3 class="pjm-about">
                The unique national-local partnership between CUNA & LSCU generates:
                </h3>
                <ul>
                            <li>Strong, coordinate Fedearl & state advocacy efforts</li>
                            <li>Real-time compliance help from experts</li>
                            <li>Public-facing efforts that grow credit unions</li>
                            <li>...and so much more. Together LSCU & CUNA create real results for our member credit unions.</li>
                        </ul>
                <p>Our member credit unions prosper as CUNA and LSCU work hand-in-hand to deliver the best results in credit union legislative advocacy, compliance assistance, and public-facing campaigns.</p>

            <p>Action across the local LSCU network leads to bigger, better impact at home and nationwide.</p>
            <p>Our member credit unions prosper as CUNA and LSCU work hand-in-hand to deliver the best results in credit union legislative advocacy, compliance assistance, public-facing campaigns, training and professional development. </p>
...
<div class="full-width about-two notched-box">
    ...
    <div class="row text">
        <div class="small-12 columns">
            ...
            <p>At the state level, LSCU daily empowers its member credit unions to grow and succeed. There’s no waiting game when you need customized compliance answers fast; LSCU and CUNA’s resources are second to none. LSCU members have access to responsive, dedicated, and well-known compliance experts Bill Berg and Mike Lee -- only a quick text, phone call or email away.
